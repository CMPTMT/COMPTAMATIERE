...
public class Modification2 extends javax.swing.JDialog {
  ...
  ArrayList tab = new ArrayList();
    ...
    try {
            ...
            cmbSecteur.setSelectedItem(secteuractiviteF.getOneResult("select LIBSECTEUR from SECTEURACTIVITE where IDSECTEUR="+f.SECTEURACTIVITE));
        ...
        codesecteur.setText(f.SECTEURACTIVITE);
        codesecteur.setVisible(false);
