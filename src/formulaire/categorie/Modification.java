...
public class Modification extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "", 1, 2));
        ...
        txtCompteD.setEditable(false);

        jLabel2.setText("Code compte divisionnaire");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txtCodeC, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jLabel5)
                        .addGap(18, 18, 18)
                        .addComponent(txtDureeVie, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(23, 23, 23)
        ...
        setBounds((screenSize.width-609)/2, (screenSize.height-338)/2, 609, 338);
  ...
  public CATEGORIE c=null;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(reponse==JOptionPane.YES_OPTION){
            try {
                String champ[]={"IDCATEGORIE", "LIBCATEGORIE", "DUREEVIE","codeicat"};
                String valeur[]={txtCodeC.getText(),txtCategorie.getText(),txtDureeVie.getText(),codeIcat.getText()};
                int i=c.updateTable("categorie", champ, valeur,"where idcategorie="+c.IDCATEGORIE);
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
       try {
            ...
            txtCodeD.setText(c.getIdDFromC(c.IDCATEGORIE));
            txtCompteD.setText(c.getLibDFromIdD(Integer.parseInt(txtCodeD.getText())));
            txtCategorie.setText(c.LIBCATEGORIE);
            txtCodeC.setText(String.valueOf(c.IDCATEGORIE));
            txtDureeVie.setText(String.valueOf(c.DUREEVIE));
            codeIcat.setText(c.codeIcat);
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this,ex.getMessage());
        }
