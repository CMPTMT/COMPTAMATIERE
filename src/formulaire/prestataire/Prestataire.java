...
public class Prestataire extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Compte principale");

        jButton4.setText("Imprimer");

        jButton1.setText("Supprimer");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Recherche", 1, 2, null, java.awt.Color.black));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtComptePrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 384, Short.MAX_VALUE)
                .addGap(71, 71, 71))
        );
        ...
        setBounds((screenSize.width-685)/2, (screenSize.height-413)/2, 685, 413);
    }// </editor-fold>//GEN-END:initComponents
     PRESTATAIRE p=new PRESTATAIRE();
    private void btnModifierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifierActionPerformed
        Modification m=new Modification();
        p.idPRESTATAIRE=(Integer.parseInt(table.getValueAt(table.getSelectedRow(),0).toString()));
        p.LIBPRESTATAIRE=(table.getValueAt(table.getSelectedRow(),1).toString());
        m.p=this.p;
        m.setVisible(true);
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        // TODO add your handling code here:
          try {
            table.setModel(p.getDefaulTableModel("select IDPRESTATAIRE,LIBPRESTATAIRE from PRESTATAIRE"));
